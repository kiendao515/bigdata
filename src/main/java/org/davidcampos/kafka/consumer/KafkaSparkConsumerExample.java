...
public class KafkaSparkConsumerExample {
    ...
    public static void main(final String... args) {
        ...
        final JavaInputDStream<ConsumerRecord<String, Job>> stream =
        ...
        JavaDStream<String> lines = stream.map((Function<ConsumerRecord<String, Job>, String>) kafkaRecord -> kafkaRecord.value().job);
